  ...
  return (
    <div className="w-full space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-6 bg-factory-800/50 border border-tire-600/30">
          <TabsTrigger
            value="pos"
        ...
        <TabsContent value="lucro-produto-final">
          <Card className="bg-factory-900/80 border-tire-600/30 max-w-7xl mx-auto">
            <CardHeader>
              ...
              <p className="text-tire-300 mt-2">
                Análise de lucratividade baseada exclusivamente no histórico de
                vendas de produtos finais (não inclui produtos de revenda)
              </p>
            </CardHeader>
            <CardContent className="bg-factory-900/60 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <Card className="bg-factory-800/50 border-tire-600/30">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-tire-300 text-sm">Vendas Totais</p>
                        <p className="text-2xl font-bold text-neon-blue">
                          {finalProductSalesHistory.length}
                        </p>
                      </div>
                ...
                <Card className="bg-factory-800/50 border-tire-600/30">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-tire-300 text-sm">Ticket Médio</p>
                        <p className="text-2xl font-bold text-neon-purple">
                          {formatCurrency(
                            finalProductSalesMetrics.averageValuePerSale,
                          )}
                        </p>
                      </div>
                      <div className="text-neon-purple">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-neon-orange">
                          {formatCurrency(
                            finalProductSalesMetrics.averageValuePerUnit,
                          )}
                        </p>
                      </div>
                      <div className="text-neon-orange">
              ...
              {finalProductSalesChartData.length > 0 && (
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-tire-200 font-medium text-lg">
                      Análise de Lucratividade por Produto Final
                    </h3>
                  </div>
                  ...
                  <div className="p-3 bg-factory-800/50 rounded-lg border border-tire-600/30">
                    ...
                    <div className="mt-3 text-center">
                      <p className="text-tire-400 text-xs">
                        📊 Análise de receita por produto final baseada no
                        histórico de vendas
                      </p>
                      <p className="text-tire-500 text-xs mt-1">
                        🟠 Laranja: Receita Total por Produto
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Detailed Product Profit Analysis */}
              <div className="space-y-4">
                <h3 className="text-tire-200 font-medium text-lg flex items-center gap-2">
                  <Package className="h-5 w-5 text-neon-orange" />
                  Análise Detalhada por Produto Final
                </h3>
                ...
                {finalProductSalesChartData.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-tire-400">
                      Nenhum dado de vendas de produtos finais disponível para
                      análise
                    </p>
                  </div>
                ) : (
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="text-neon-blue font-bold">
                                {product.totalQuantity.toFixed(0)} un.
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-tire-300">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="text-neon-cyan font-bold">
                                {formatCurrency(
                                  product.totalValue / product.salesCount,
                                )}
                              </span>
                            </div>
                          </div>
              ...
              {/* Summary Statistics */}
              {finalProductSalesHistory.length > 0 && (
                <div className="mt-6 p-4 bg-factory-800/50 rounded-lg border border-tire-600/30">
                  <h3 className="text-tire-200 font-medium text-lg mb-4 flex items-center gap-2">
                    <BarChart3 className="h-5 w-5 text-neon-orange" />
                    Resumo Geral - Produtos Finais
                  </h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    <div className="text-center">
                      <p className="text-tire-300 text-sm mb-1">
                    ...
                    <div className="text-center">
                      <p className="text-tire-300 text-sm mb-1">Ticket Médio</p>
                      <p className="text-neon-orange font-bold text-lg">
                        {formatCurrency(
                          finalProductSalesMetrics.averageValuePerSale,
                        )}
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-neon-yellow font-bold text-lg">
                        {finalProductSalesMetrics.averageQuantityPerSale.toFixed(
                          1,
                        )}
                      </p>
                    </div>
